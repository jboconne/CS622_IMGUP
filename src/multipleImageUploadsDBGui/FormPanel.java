...
public class FormPanel extends JPanel {
	...
	private JLabel addSubCategoryLabel;
	private JTextField addSubCategoryNameField;	
	...
	public FormPanel() {
		...
		addCategoryLabel = new JLabel("Add New Category: ");
		addCategoryNameField = new JTextField(20);
		addSubCategoryLabel = new JLabel("Add New Sub Category: ");
		addSubCategoryNameField = new JTextField(20);
		...
		uploadBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String categorySelected = (String)catCombo.getSelectedItem();
				String subCategorySelected = (String)subCatCombo.getSelectedItem();	
				String category = addCategoryNameField.getText();
				String subCategory = addSubCategoryNameField.getText();
				...
				FormEvent ev = new FormEvent(this, category, subCategory, categorySelected, subCategorySelected, myImageUploads);
...
//		gc.anchor = GridBagConstraints.LINE_END;
//		gc.insets = new Insets(0,0,0,5);
//		add(addCategoryLabel, gc);
//		
//		gc.gridx = 1;
//		gc.anchor = GridBagConstraints.LINE_START;
//		gc.insets = new Insets(0,0,0,0);
//		add(addCategoryNameField, gc);
...
//		gc.anchor = GridBagConstraints.LINE_END;
//		gc.insets = new Insets(0,0,0,5);
//		add(addSubCategoryLabel, gc);
//		
//		gc.gridx = 1;
//		gc.anchor = GridBagConstraints.LINE_START;
//		gc.insets = new Insets(0,0,0,0);
//		add(addSubCategoryNameField, gc);
